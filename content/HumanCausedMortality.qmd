...
The annual human-caused M/SI report is produced in the format of [Carretta et al. 2024](https://repository.library.noaa.gov/view/noaa/66175), and traditionally includes the most recent five years of available data. To generate an annual report, you will use R scripts and an R Markdown file housed in the [SWFSC/MSI-report](https://github.com/SWFSC/MSI-report) repository (accessible to all NOAA Github Enterprise users) to produce an automated report based on the [Anthropogenic_Mortality_Serious_Injury_Carretta.xls](https://github.com/SWFSC/MSI-data/blob/main/Anthropogenic_Mortality_Serious_Injury_Carretta.xlsx) file. Detailed instructions are provided within the [SWFSC/MSI-report](https://github.com/SWFSC/MSI-report) repository, and include these main steps:

1. Run 'SeriousInjuryExtract.R' to data mine [Anthropogenic_Mortality_Serious_Injury_Carretta.xls](https://github.com/CMAP-SWFSC/CMAP-SWFSC/blob/main/content/Anthropogenic_Mortality_Serious_Injury_Carretta.xlsx). Running this script produces an RData file, which interacts with the steps 2 and 3.
