...
Quantifying human-caused mortality and serious injury (HCMSI) is integral to producing marine mammal stock assessments. Sources of HCMSI include fishery bycatch, marine debris entanglements, shootings, acoustic trauma, and vessel strikes.
...
The annual report is based on data-mining an Excel file [“Anthropogenic_Mortality_Serious_Injury_Carretta.xls”](https://github.com/CMAP-SWFSC/CMAP-SWFSC/blob/main/content/Anthropogenic_Mortality_Serious_Injury_Carretta.xlsx) that is updated annually. The annual HCMSI report includes the most-recent 5 years of data to inform SARS.\
