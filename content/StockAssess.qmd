...
The Pacific SAR editor coordinates the annual revision of reports, along with the Office of Protected Resources (OPR review of draft and final reports).
...
Draft SARs are submitted to the SRG liaison (Laura.McCue\@noaa.gov PIFSC) 6 weeks before the meeting, so that 1) OPR can have 3 weeks to review them for issues and 2) the SRG liaison can send them to the Pacific Scientific Review Group (PSRG) 3 weeks before the meeting.
...
Some examples of how actual revisions should appear are shown in Figure 1.

![Figure 1](content/images/SARTrackChanges.png){width="800"}

## R-Code related to SARS

See the [code folder](https://github.com/CMAP-SWFSC/CMAP-SWFSC/tree/main/\_code) of this repository.
Plot sightings and effort maps directly from DAS data: **Plot DAS Effort and Sightings Data SAR version.R** 
Code loops through all species codes and generates JPEG maps of on-effort segments and on + off-effort sightings.
