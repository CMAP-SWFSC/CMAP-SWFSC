...
## SeriousInjury
`SeriousInjury` uses Random Forest classification trees to assess injury severity of large whale entanglements and vessel strikes. Discussed under [Human-Caused Mortality](https://cmap-swfsc.github.io/CMAP-SWFSC/content/HumanCausedMortality.html).
