...
Knitting the document also produces an Excel file with transect points: ![](images/MMTD_Survey_Planner_output.PNG){width="900} 
which looks like this: ![](images/MMTD_Survey_Planner_output_Excel.PNG){width="\"900"} 
Individual transects may contain \> 2 points, as new segments are generated when a transect crosses a land or island boundary.
