...
Another useful script interacts with the R-Package swfscDAS and a DAS file to produce a tabular, CSV format summary of all sightings data: "get_Sightings_swfscDAS.R" (see Carretta's old directories, or just read the swfscDAS vignette to use the functions directly).
