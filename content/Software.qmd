...
The R-markdown file will generate a series of plots, corresponding to sections of the code: 
![](images/MMTD_Survey_Planner_Base_Map1.PNG){width="900"} ![](images/MMTD_Survey_Planner_Base_Map2.PNG){width="900"}
