...
The version of the CAPTURE program used by Barlow and Calambokidis (2020) to estimate abundance using a Chao Mth model, and a function for running it, are available in the [`CMRutils`](https://github.com/kacurtis/CMRutils) repository on GitHub, which has been forked to the [SWFSC GitHub Enterprise](https://github.com/SWFSC/CMRutils) organization.
